function ClimateChange() {
    ...
    this.filename = 'surface-temperature.csv';
    this.rerange = false;
    ...
    this.preload = function () {
        ...
        this.data = loadTable(
            ...
            './data/surface-temperature/' + this.filename, 'csv', 'header',
    ...
    this.setup = function () {
        ...
        this.fileDiv.mouseOver(function () {
            if(!localStorage["ccalertdisplayed"]) {
                alert("NAVIGATE TO FOLDER: data/surface-temperature !!!")
                localStorage["ccalertdisplayed"] = true
            }
        });

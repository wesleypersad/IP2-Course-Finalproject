function ChildSurvivalVsGdp() {
    ...
    this.filenames =    ['t30_population_total.csv',
                        't30_child_mortality.csv',
                        't30_income_per_person.csv'];
    this.rerange = false;
    ...
    this.preload = function () {
        ...
        this.data1 = loadTable(
            //'./data/child-survival/t30_population_total.csv', 'csv', 'header',
            './data/child-survival/' + this.filenames[0], 'csv', 'header',
        ...
        this.data2 = loadTable(
            //'./data/child-survival/t30_child_mortality.csv', 'csv', 'header',
            './data/child-survival/' + this.filenames[1], 'csv', 'header',
            // Callback function to set the value
            // this.loaded to true.
            function (table) {
                self.loaded2 = true;
        ...
        this.data3 = loadTable(
            //'./data/child-survival/t30_income_per_person.csv', 'csv', 'header',
            './data/child-survival/' + this.filenames[2], 'csv', 'header',
            // Callback function to set the value
            // this.loaded to true.
            function (table) {
                self.loaded3 = true;
    ...
    this.setup = function () {
        ...
        // call function to get min and max years
        this.recalcAxis();
        ...
        // same for child survival & log scale values
        this.minSurv = 30;
        this.maxSurv = 100;
        this.minSurvL10;
        this.maxSurvL10;
        ...
        // calculated the upper and lower bounds of x in log scale
        this.startGDPL10 = Math.floor(Math.log10(this.startGDP));
        this.endGDPL10 = Math.ceil(Math.log10(this.endGDP));
        
        //recalculated upper limit of x scale to match log value
        this.endGDP = Math.pow(10,this.endGDPL10);
        ...
        this.fileDiv.mouseOver(function () {
            if(!localStorage["csalertdisplayed"]) {
                alert("NAVIGATE TO FOLDER: data/child-survival !!!")
                localStorage["csalertdisplayed"] = true
            }
        });
        ...
        var self = this;
        this.maxYInput = createInput(this.maxSurv.toString());
        this.maxYInput.style('background-color', 'gold');
        this.maxYInput.style('text-align', 'right');
        this.maxYInput.position(320, 20);
        this.maxYInput.size(25);
        ...
        var self = this;
        this.minYInput = createInput(this.minSurv.toString());
        this.minYInput.style('background-color', 'gold');
        this.minYInput.style('text-align', 'right');
        this.minYInput.position(320, 530);
        this.minYInput.size(25);
    ...
    this.draw = function () {
        ...
        if (!this.xL10) {
                ...
                var xLabelSkip = ceil(this.endGDP / this.layout.numXTickLabels);
                ...
                for (var i = this.startGDPL10; i <= this.endGDPL10; i++) {

...
function drawAxisPlus(layout, colour=0) {
  stroke(color(colour));
...
// drawXAxisTickLabel modificed to show labels on a log scale
//
function drawXAxisTickLabelL10(value, layout, mapFunction) {
  // Map function must be passed with .bind(this).
  var x = mapFunction(value);
